                ...
                <div class="card card-profile shadow">
                    ...
                    <div id="buttons" class="text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4 mr-1 ml-1">
                        <div class="d-flex justify-content-between">
                            <a href="#" id="connect_button" class="btn btn-sm btn-info mr-4"  onclick="connect($('#upro_img').attr('data-id') ,$('#username-header').attr('user-id') , document.getElementById('upro_img').src, ( $('#profile_input_user_first_name').val() + ' ' +  $('#profile_input_user_last_name').val()), $('#username-header').attr('user-name'), false, false)" hidden>Connect</a>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <select id="smoking_picker" class="form-control mb-3">
